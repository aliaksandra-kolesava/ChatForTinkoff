...
var conversationCellModel: [ConversationCellModel] = [
    ...
    ConversationCellModel(name: "Arthur Bell", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: true, hasUnreadMessages: false),
    ConversationCellModel(name: "Jane Warren", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: false, hasUnreadMessages: false),
    ...
    ConversationCellModel(name: "Irma Flores", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: false, hasUnreadMessages: true),
    ConversationCellModel(name: "Colin Williams", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: false, hasUnreadMessages: true),
    ...
    ConversationCellModel(name: "Megan Bell", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: true, hasUnreadMessages: false),
    ConversationCellModel(name: "Johanna Warren", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: false, hasUnreadMessages: false),
    ConversationCellModel(name: "Donald Dobertson", message: "", date: Date(timeIntervalSince1970: -1.0), isOnline: true, hasUnreadMessages: false),
       ConversationCellModel(name: "John Catson", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: true, hasUnreadMessages: true),
    ConversationCellModel(name: "Sam Robertson", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date(timeIntervalSinceReferenceDate: -1456789.0), isOnline: true, hasUnreadMessages: true),
       ConversationCellModel(name: "Rohn Batson", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: true, hasUnreadMessages: true),
    ...
    ConversationCellModel(name: "Sam Henry", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: false, hasUnreadMessages: true),
    ConversationCellModel(name: "Irma Flores", message: MessagesExample().messages[MessagesExample().messages.count - 1].text, date: Date.init(), isOnline: false, hasUnreadMessages: true),
